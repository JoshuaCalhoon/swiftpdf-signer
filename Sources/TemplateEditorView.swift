...
struct TemplateEditorView: View {
    ...
    var body: some View {
        navigationStack
            // Hide template body from the App Switcher snapshot iOS captures
            // on scene transitions. Manager-edited template wording can be
            // customer-relevant (acknowledgments, internal phrasing); shield
            // it the same way customer-fill content is shielded. See
            // PrivacyShield.
            .privacyShield()
    }
